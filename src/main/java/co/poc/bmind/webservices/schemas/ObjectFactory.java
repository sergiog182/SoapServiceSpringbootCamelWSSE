 ...
 * generated in the co.poc.bmind.webservices.schemas package. 
...
public class ObjectFactory {
    ...
    private final static QName _Aplicacion_QNAME = new QName("http://www.bmind.poc.co/webservices/schemas", "aplicacion");
    private final static QName _Id_QNAME = new QName("http://www.bmind.poc.co/webservices/schemas", "id");
    private final static QName _Correcto_QNAME = new QName("http://www.bmind.poc.co/webservices/schemas", "correcto");
    private final static QName _Error_QNAME = new QName("http://www.bmind.poc.co/webservices/schemas", "error");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.poc.bmind.webservices.schemas
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bmind.poc.co/webservices/schemas", name = "aplicacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bmind.poc.co/webservices/schemas", name = "id")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bmind.poc.co/webservices/schemas", name = "correcto")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.bmind.poc.co/webservices/schemas", name = "error")
